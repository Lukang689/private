  ...
  MtaH5.hack = function () {
    ...
    if (0 == b.length)
      for (var r = document.getElementsByTagName("script"), p = 0; p < r.length; p++)
        if ("undefined" !== typeof r[p].attributes.name && "MTAH5" == r[p].attributes.name.nodeValue) {
          b = [];
          b.push(r[p]);
          break
        }
...
(function (b, t) {
  ...
  function p(a) {
    ...
    h && function () {
      for (var c = h.split("&"), a = 0, b = c.length; a < b; a++)
        if (-1 != c[a].indexOf("=")) {
          var e = c[a].indexOf("="),
            k = c[a].slice(0, e);
          e = c[a].slice(e + 1);
    ...
    h = function () {
      ...
      for (var a = h.split("&"), c = [], d = 0, e = a.length; d < e; d++)
        if (-1 != a[d].indexOf("=")) {
          var k = a[d].indexOf("="),
            n = a[d].slice(0, k);
          k = a[d].slice(k + 1);
    ...
    if (b.sid)
      if (!b.userReport || b.user.user_id && !parseInt(b.user.user_id, 10) !== b.user.user_id) {
        ...
        for (var c = 0, e = [u(), x(), {
          ...
          for (d in e[c]) e[c].hasOwnProperty(d) && a.push(d + "=" + ("undefined" == typeof e[c][d] ? "" : e[c][d]));
        var g = function (a) {
        ...
        b.performanceMonitor && (d = function () {
            ...
            for (var h = n.length; e < h; e++)
              for (var q in n[e]) n[e].hasOwnProperty(q) && a.push(q + "=" + ("undefined" == typeof n[e][q] ? "" : n[e][q]));
  ...
  Ta.clickStat = MtaH5.clickStat = function (a, d) {
    ...
    if (e.cid) {
      ...
      for (f = g.length; m < f; m++)
        for (var l in g[m]) g[m].hasOwnProperty(l) && h.push(l + "=" + ("undefined" ==
          typeof g[m][l] ? "" : g[m][l]));
  ...
  Ta.clickShare = MtaH5.clickShare = function (a) {
    ...
    if (c.cid) {
      ...
      for (f = g.length; a < f; a++)
        for (var m in g[a]) g[a].hasOwnProperty(m) && e.push(m + "=" + ("undefined" == typeof g[a][m] ? "" : g[a][m]));
